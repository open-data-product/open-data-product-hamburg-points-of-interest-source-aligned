...
def extract_overpass_data(source_path, results_path, clean=False, quiet=False):
    ...
    # Define bounding box
    bounding_box = [9.730130859481674, 53.39501084654235, 10.325276797368112, 53.73943730358849]
    ...
    for points_of_interest_query in points_of_interest_queries:
        ...
        file_path = os.path.join(results_path, "hamburg-points-of-interest",
                                 f"hamburg-points-of-interest-{name.replace('_', '-')}-details.json")
